...
#include<conio.h>
#include<stdlib.h>/*block or tile whatever it might bt and fill it with ascii characters nothing fancy just simple ocde!*/
...
void render(int x,int y,int flag)
{
 ...
 void create_tile()
{
 int cursor_x=8,cursor_y=8,run,tile[16][16];
 int i,j;	
